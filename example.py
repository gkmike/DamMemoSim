...
my_adv_cards = MyCards([
    Adventurer("新裝艾斯", 3957+1475, 371+ 130,
                2133 + 808, 583+203, 867+316, 1088+384, 445+127, tags=[Damage.phy, Damage.ice, Scope.foe, Scope.foes],
               skills=[
                   Skill(mp=47,
    ...
    Adventurer("英雄阿爾戈", 4017+1475, 356+130,
                2180 + 813, 722+316, 750+263, 1141+369, 440+122, tags=[Damage.phy, Damage.fire, Scope.foe, Scope.foes],
               skills=[
    ...
    Adventurer("聖誕千草", 3903+1445, 377+130,
                2011 + 748, 599+203, 841+306, 1115+349, 403+112, tags=[Damage.phy, Damage.ice, Scope.foe, Scope.foes],
    ...
    Adventurer("歌殺", 3897+1475, 386+130,
                2120 + 806, 584+209, 773+262, 1108+348, 440+122, tags=[Damage.phy, Damage.dark, Mission.one_shot, Scope.foe],
               skills=[
                   Skill(mp=45,
                       debuffs=[Effect(Scope.foes, Endurance.phy, 0.30, 4), Effect(Scope.foes, Endurance.dark, 0.30, 4),
                                Effect(Scope.foes, Ability.crit_rate, 0.3, 4), Effect(Scope.foes, Ability.pene_rate, 0.3, 4)]),
    ...
    Adventurer("聖誕樁", 3785+1475, 342+130,
                1751+732, 567+195, 761+260, 1101+356, 440+122, tags=[Damage.phy, Damage.ice, Scope.foe, Scope.foes, Mission.one_shot],
               skills=[
    ...
    Adventurer("折紙", 4045+1425, 414+140,
                423+87, 548+205, 737+216, 929+216, 2045 + 880, tags=[Damage.mag, Damage.light, Scope.foe, Scope.foes],
               skills=[
    ...
    Adventurer("春姬", 3740+1450, 438+160,
                1100+197, 529+183, 908+305, 913+262, 1737 + 667, tags=[Damage.mag, Damage.fire, Scope.foe, Scope.foes],
               skills=[
                   ...
                   Skill(mp=12, buffs=[Effect(Scope.my_self, Recover.mp, 0.15), 
                                       Effect(Scope.my_team, Ability.counter_rate, 0.30, 3), Effect(Scope.my_team, Ability.pene_rate, 0.30, 3)]),
    ...
    Adventurer("泳裝媽媽", 2744+864, 334+88,
                326+64, 280+99, 673+246, 589+211, 1179+426, tags=[Damage.mag, Damage.ice, Scope.foe, Mission.one_shot],
               skills=[
...
boss_cards = MyCards([
    ...
    Adventurer("骷髏-小", 100000000, 0,
                500, 150, 0, 0, 0,
               skills=[Skill(buffs=[Effect(Scope.my_self, Endurance.phy, 0.2, 3), Effect(Scope.my_self, Endurance.mag, 0.2, 3)]),
                       Skill(Scope.foe, Power.low, Damage.none, Attack.phy)],
               passive_skills=[Skill(debuffs=[Effect(Scope.my_self, Endurance.thunder, 0.6), Effect(Scope.my_self, Endurance.light, 0.3)])]
               ),
    Adventurer("骷髏-大", 100000000, 0,
               ...
               passive_skills=[Skill(debuffs=[Effect(Scope.my_self, Endurance.thunder, 0.3), Effect(Scope.my_self, Endurance.light, 0.6)])]
               ),
])
